...
namespace BDEase
{
    ...
    public static class Easings
    {
        ...
        /// Returns the Func named by `thiz`. It's cached internally.
        public static Func<float, float> AsEase(this Enum thiz) => thiz switch
        {
            Enum.Linear => Linear,
            Enum.InQuad => InQuad,
            Enum.OutQuad => OutQuad,
            Enum.InOutQuad => InOutQuad,
            Enum.InCubic => InCubic,
            Enum.OutCubic => OutCubic,
            Enum.InOutCubic => InOutCubic,
            Enum.InQuart => InQuart,
            Enum.OutQuart => OutQuart,
            Enum.InOutQuart => InOutQuart,
            Enum.InQuint => InQuint,
            Enum.OutQuint => OutQuint,
            Enum.InOutQuint => InOutQuint,
            Enum.InSine => InSine,
            Enum.OutSine => OutSine,
            Enum.InOutSine => InOutSine,
            Enum.InExpo => InExpo,
            Enum.OutExpo => OutExpo,
            Enum.InOutExpo => InOutExpo,
            Enum.InCirc => InCirc,
            Enum.OutCirc => OutCirc,
            Enum.InOutCirc => InOutCirc,
            Enum.InBack => InBack,
            Enum.OutBack => OutBack,
            Enum.InOutBack => InOutBack,
            Enum.InElastic => InElastic,
            Enum.OutElastic => OutElastic,
            Enum.InOutElastic => InOutElastic,
            Enum.InBounce => InBounce,
            Enum.OutBounce => OutBounce,
            Enum.InOutBounce => InOutBounce,
