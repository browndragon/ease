...
namespace BDEase
{
    public static class UnityAriths
    {
        ...
        public static void Initialize() => Arith.InitializeAssemblyContaining(typeof(UnityAriths));
    }
    [Arith.DefaultFor(typeof(Vector2))]
    ...
    [Arith.DefaultFor(typeof(Vector3))]
    ...
    [Arith.DefaultFor(typeof(Vector4))]
